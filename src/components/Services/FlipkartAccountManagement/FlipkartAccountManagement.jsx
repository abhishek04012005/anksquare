...
import FlipkartAccountSVG from '../../../assets/SVG/FlipkartAccountSVG/FlipkartAccountSVG';

const FlipkartAccountManagement = () => {
    return (
        <>
            <ServiceBox
                serviceTitle="flipkart account management"
                photo={<FlipkartAccountSVG/>}
